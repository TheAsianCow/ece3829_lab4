...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(Clk, Reset, UART_rxd, UART_txd, GPIO1_tri_i, 
  GPIO1_tri_o, GPIO2_tri_o, GPIO3_tri_o, GPIO4_tri_o)
/* synthesis syn_black_box black_box_pad_pin="Clk,Reset,UART_rxd,UART_txd,GPIO1_tri_i[7:0],GPIO1_tri_o[7:0],GPIO2_tri_o[31:0],GPIO3_tri_o[31:0],GPIO4_tri_o[31:0]" */;
  input Clk;
  input Reset;
  input UART_rxd;
  output UART_txd;
